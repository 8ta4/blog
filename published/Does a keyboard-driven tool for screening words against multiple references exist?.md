I hate that feeling when everyone else in the room knows a word. It's brutal when you're a comedian and a heckler drops a term you've never heard. To fix that, I built [a dataset](https://github.com/8ta4/pun-data/blob/4b5a2c1eeb992d2c1b8faea2488768eaac6be9dc/normalized.edn.gz) of about 100k words and 100k phrases that a large language model identifies as recognizable by 50% of Americans.
...
- Multi-reference trigger: I need a shortcut that fires off multiple URLs simultaneously into specific, reusable windows, so my tabs don't explode into a mess. I use [`yabai`](https://github.com/asmvik/yabai) and [`skhd`](https://github.com/asmvik/skhd) to arrange windows in a fixed layout and switch between them.

- Browser extensions: The browser windows have to play nice with extensions like [uBO Lite](https://github.com/uBlockOrigin/uBOL-home) and [Vimium](https://github.com/philc/vimium).
...
- I built this dataset for [a pun generator](https://github.com/8ta4/pun). You can check [the documentation](https://github.com/8ta4/cue/blob/668cc50c80e651307278a7bee1b94fee411f749f/DONTREADME.md) for how I generated the dataset.

- I can trim down the 100k figure. I plan on using Wiktionary categories to filter by [English lemmas](https://en.wiktionary.org/wiki/Category:English_lemmas) to make the screening task more manageable.

I'm willing to compromise on the specifics. Has anyone seen a tool that handles this?

I originally [posted](https://old.reddit.com/r/Anki/comments/1szhvc1/does_a_keyboarddriven_tool_for_screening_words) this in r/Anki. But someone told me, "[This has nothing to do with Anki.](https://old.reddit.com/r/Anki/comments/1szhvc1/does_a_keyboarddriven_tool_for_screening_words/oj2oi6r)"
