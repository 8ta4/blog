...
The streaming API doesn't quite hit the mark in terms of accuracy. I was hoping for transcription that's faster than light, but it turned out to be faster than right.
