I've scored about a million English entries from Wiktionary for recognizability. I built this for [a pun tool](https://github.com/8ta4/pun). But I want to use [the data](https://github.com/8ta4/pun-data/blob/4b5a2c1eeb992d2c1b8faea2488768eaac6be9dc/normalized.edn.gz) for a new language project.
