...
u/velrok7 [suggested](https://old.reddit.com/r/neovim/comments/1pq47fc/looking_for_a_neovim_plugin_for/nuu69r9) using an LLM to build a plugin. I've tried Claude 4.7 Opus and Gemini 3.1 Pro. But they haven't worked out as pair programmers for me. I find myself micromanaging them. So for this next plugin, I want to treat the agent as an abstraction layer and let it play fast and Lua.
