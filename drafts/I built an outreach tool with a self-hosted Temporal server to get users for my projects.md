...
Relying on SaaS for this felt like I'd be doing myself a disservice, and that would make me SaaD. So I built [my own system](https://github.com/8ta4/spam) using a self-hosted Temporal workflow engine instead.
